...
const ProductDetails = () => {
  ...
  const reviewHandler = () => {
    ...
    if (!rating || !comment) {
      alert.error("Please make sure you submit a rating and comment.");
    } else {
        ...
        <Fragment>
          ...
          <div className="row f-flex justify-content-around">
            ...
            <div className="col-12 col-lg-5 mt-5">
              ...
              <div
                className="rating-outer text-center"
              ...
              <p id="product_price" style={{ marginLeft: "5em" }}>
                ${product.price}
              </p>
              <div
              ...
              <h4
                className="mt-2"
                style={{ marginLeft: "7em", fontWeight: "700" }}
              >
                Description:
              </h4>
              <p>{product.description}</p>
              <hr style={{ border: "1px solid grey" }} />
              <p id="product_seller mb-3" style={{ marginLeft: "10em" }}>
                    ...
                    <div className="modal-dialog" role="document">
                      <div className="modal-content">
                        ...
                        <div className="modal-body">
                          <ul className="stars" style={{ marginLeft: "5em" }}>
                            <li className="star">
